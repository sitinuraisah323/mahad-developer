                ...
                <form id="example-form" onsubmit="submitform(event)">
                  <div class="card-body">
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="sub_subject" name="sub_subject" placeholder="Judul Sub Subject">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <textarea id="summernoteExample" name="summernoteExample" placeholder=""></textarea>
                    </div>
