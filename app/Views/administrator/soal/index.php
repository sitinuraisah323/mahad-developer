    ...
    <div class="content-wrapper">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ModalLabel">Form add Soal</h5>
        ...
        <script type="text/javascript">
            ...
            const submitform = (event) => {
                ...
                if (id === '') {
                    axios.post(`<?php echo base_url(); ?>/api/Soal/Soal/insert`, formData).then(res => {
                    ...
                    axios.post(`<?php echo base_url(); ?>/api/Soal/Soal/updated`, formData).then(res => {
                        let status = res.data.status;
                        let data = res.data.data;
                        if (status === 422) {
                            let message = Object.values(data)[0];
            ...
            const initDataTable = () => {
                dataTable = $('#table-1').DataTable({
                    ...
                    serverSide: false,
                    ajax: {
                        url: `<?php echo base_url(); ?>/api/Soal/Soal/getSoal`,
            ...
            const btnDelete = (id) => {
                axios.get(`<?php echo base_url(); ?>/api/Soal/Soal/view/${id}`).then(res => {
                    swal({
                        title: 'Are you sure?',
                        ...
                        if (willDelete) {
                            axios.get(`<?php echo base_url(); ?>/api/Soal/Soal/deleted/${id}`).then(res => {
            ...
            const btnEdit = (id) => {
                axios.get(`<?php echo base_url(); ?>/api/Soal/Soal/view/${id}`).then(res => {
                    ...
                    $('#addSubject').find('[name="id_materi"]').val(res.data.data.id_materi);
